...
The `SD` and `SPI` libraries are built into the Arduino core for the ESP32, so you don't need to add any new dependencies to your `platformio.ini`.
...
If you pop the SD card out and put it into your computer, you should find a `weather_data.csv` file containing all the saved measurements. 
