...
A learning-oriented IoT project covering the full stack: embedded firmware, solar power, automated data pipeline, and machine learning on local sensor data. Sensor set covers standard meteorology plus soil moisture and rainfall — targeting small-scale precision agriculture use cases.
